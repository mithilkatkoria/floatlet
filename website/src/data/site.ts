...
export const product = { name:'Floatlet', description:'Floatlet is a free, open-source Dynamic Island for Windows 10 and 11. Keep music, file references, timers, calendar reminders and everyday controls close.', repository:'https://github.com/mithilkatkoria/floatlet', support:'https://github.com/mithilkatkoria/floatlet/issues', author:'Mithil Katkoria', origin:import.meta.env.SITE_ORIGIN || 'https://floatlet.vercel.app', mode:import.meta.env.SITE_MODE || 'production', consentVersion:'1', legalApproved:false, mediaApproved:false };
